...
<br> A vibrant developer traversing the realms of web development with a knack for creating seamless experiences using Next Js, TypeScript, React JS, JavaScript, HTML, and CSS. Python is my versatile companion, empowering me in a spectrum of projects. Delving into Java, I enjoy sculpting elegant solutions through algorithms and data structures.<br><br>🌱 Learning Journey: I am currently immersing myself in the intricacies of Machine Learning, seeking to unravel its mysteries and integrate it into my problem-solving arsenal.<br><be>
